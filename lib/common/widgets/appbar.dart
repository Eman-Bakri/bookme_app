...
class BMAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: BMSizes.md),
      child: AppBar(
  ...
  Size get preferredSize => Size.fromHeight(BMDeviceUtility.getAppBarHeight());
}
